...
\begin{enumerate}
 \item NumPy, útgáfa 1.6.0c1 eða nýrra\\ \url{http://numpy.scipy.org/}
...
Filter: Lámarksgildi á flaggi sem skilað er. \\
MaxTimelineSize: Hámarksstærð á tímalínu sem kerfið greinir. \\
