...
Í skýrslunni er náin lýsing á verkefninu og hvernig verkáætlun var háttað.
...
Hvert gagnasett hjá DataMarket inniheldur tímalínur sem sýna þróun tölulegra
...
Sú þróun sem ein tímalína sýnir getur verið allt frá vel þekktum gildum t.d. verðbólgu, atvinnuleysi eða
hitastigi í Reykjavík, til mjög sérhæfðra eða jafnvel undarlegri hluta eins og 
innflutningsverðmæti leðurvara frá Brasilíu! \todo{endurskrifa í heild?}
...
í gögnum sem fáir fylgjast með og enginn tekur etv. eftir. 
...
eingöngu með nýjustu uppfærslurnar og varð því yfirgripsmeira en
...
Þegar byrjað var að skipuleggja verkefnið varð fljótlega greinilegt að verkefnið 
fæli í sér töluverðar rannsóknir, þ.e. að finna út hvaða reiknirit væru hentug, 
því myndi Scrum aðferðafræði henta okkur vel. 
Hún býður uppá skjót viðbrögð þegar breytinga er þörf og 
...
Sá fyrri stóð yfir fyrstu tólf vikurnar og var hugsaður til að búa til frumgerð að kerfinu.
...
tveggja vikna sprettir og í þeim seinni þrír. Í sjötta sprett gerðum við ráð fyrir lokaprófum og var hann því
...
Eitt af því fyrsta sem við gerðum þegar var að ákveða hvenær 
vikunnar við myndum vinna að verkefninu.
...
\section{Útfærsla}
\label{sec:imp_our}
\todo[inline]{útskyra rammastærð.. folk greinir...}
...
$\%b$\footnote[1]{Útskýringu á upprunalegu $\%b$ formúlunni og afhverju hún gagnast okkur ekki í óbreyttri mynd er að finna í tækniskýrslu á meðfylgjandi geisladisk}. 
\\ \hfil
\\ \hfil
Okkar útgáfa af $\%b$ virkar sem svo:
\begin{itemize}
...
\todo[inline]{fært endurorða}
Hinsvegar eru annmarkar á þessari aðferð. 
Sem dæmi má nefna línur sem innihalda mikinn fjölda punkta.
Líta má á að þær tímalínur hafi \ilqq hærri\irqq \hspace{1pt} upplausn en þær sem innihalda fáa punkta. Í
...
Sem annað dæmi væri hægt að hugsa sér tímalínu sem hækkar töluvert upp í ákveðinn
...
\section{Framvinda}
\subsection{Sprettir}
\todo[inline]{stuttann ingang af sprettu}

\subsubsection{Sprettur 0}
Sprettur 0 var til undirbúnings. Ekki voru sögur eins og í
hefbundnum spretti heldur skipulögðum verkáætlun, gerðum áhættugreiningu og unnum að ýmsum öðrum
undirbúningi.
...
í einum sprett. Settum upp aðgerðarsöfn(e. libraries) sem voru til þess fallin að
...
Hugmyndavinnu að frekari reikniaðgerðum haldið áfram.
\begin{figure}[H]
 \centering
...
yfirfarin. Sett upp villu og athugasemdakerfi(e. logging system). Framkvæmdum álagsprófannir og 
yfirfórum niðurstöður úr þeim. Fínstillingar á reikniritum í og villur lagfærðar. 
