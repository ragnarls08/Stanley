...
Þessa föstu sveiflu í tímalínunni greinir Fourier og skilar grafi á
mynd~\ref{fig:fouriergraph}. 
...
$\%b$\footnote[1]{Útskýringu á upprunalegu $\%b$ formúlunni er að finna í
tækniskyrslu á meðfylgjandi geisladisk}. 
Útgáfan okkar gefur púnkti tölugildi á bilinu 0-1 ef hann er á milli Bollinger
bandanna.
Ef púnkturinn liggur utan þeirra fær hann tölugildi sem samsvarar hlutfallslegri
...
%visað í tækniskyrslu í staðinn
\begin{comment}
