...
\begin{itemize}
\item Daglegir fundir (e. daily standup)
\begin{itemize}
\item Stuttur standandi fundur sem haldin var á hverjum vinnudegi þar sem að hver hópmeðlimur sagði hvað hann var að gera síðasta vinnudag, hvað hann ætlaði að gera þann dag og hvort e-ð stæði í vegi fyrir því að hann gæti gert það.
\end{itemize}
