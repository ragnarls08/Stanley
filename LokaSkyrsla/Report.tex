...
\begin{figure}[H]
  \centering
  \includegraphics[width=.58\textwidth]{rynir_class_diagram.png} 
  \caption{Klasarit} 
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.58\textwidth]{rynir_sequence-2.png} 
  \caption{Flæðirit} 
\end{figure}
...
Útgáfan okkar gefur punkti tölugildi á bilinu 0-1 ef hann er á milli Bollinger bandanna.
Ef punkturinn liggur utan þeirra fær hann tölugildi sem samsvarar hlutfallslegri fjarlægð hans frá meðaltali rammans, 
