...
Í Scrum eru tilgreindar athafnir. Við notuðum eftirfarandi athafnir til að hjálpa okkur við skipulagninu og umsýslu verkefnisins.
Þessar athafnir voru: 

\begin{itemize}
\item Daglegir standandi fundir (e. daily standup)
\begin{itemize}
\item Stuttur fundur sem haldin var á hverjum vinnudegi þar sem að hver hópmeðlimur sagði hvað hann var að gera síðasta vinnudag, hvað hann ætlaði að gera þann dag og hvort e-ð stæði í vegi fyrir því að hann gæti gert það.
\end{itemize}
\item Skipulagsfundir spretta (e. sprint planing)
\begin{itemize}
\item Sögur valdar inn í viðkomandi sprett. Hver og ein saga brotin niður í verkefni og áætlaðir tímar á hvert þeirra. 
\end{itemize}
\item Gagnrýnisfundir spretta (e. sprint retrospective)
\begin{itemize}
\item Fundur sem var haldinn í lok hvers spretts þar sem að við ræddum hvernig viðkomandi sprettur gekk fyrir sig, hvað okkur fannst ganga vel og hvað illa. Þessir fundir nýttust vel til að vekja athygli á því sem fór vel og einnig til að læra af mistökum sem urðu í sprettinum.
\end{itemize}
\end{itemize}
...
\begin{figure}[H]
  ...
  \caption{Flæðirit} 
\end{figure}
\todo[inline]{laga flæði og vísun í mynd}
