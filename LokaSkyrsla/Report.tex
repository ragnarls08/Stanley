...
Í þessum kafla verður farið yfir helstu þætti verkskipulagsins. Hvaða aðferðarfræði var beitt og helstu eiginleikum hennar gert skil. 
Greint er frá tímaáætlun og sagt frá hvernig gekk að fylgja henni eftir ásamt því að tilgreina þær vinnureglur sem við settum okkur. Að lokum 
er farið yfir hvernig staðið var að prófunum á kerfinu.
...
\\ \hfill
\\
Almennt gekk mjög vel að vinna eftir þessu skipulagi. Ef einhver var fjarverandi 
var þess gætt að það væri unnið upp síðar. Einungis í sprett fjögur náðist ekki að 
standa við áætlunina, svo einhverju nemur. Það var síðasti sprettur fyrir lokapróf og fór meiri tími í að 
sinna verkefnaskilum og prófaundirbúningi en áætlunin gerði ráð fyrir. Áætluðum við í upphafi að vinna 1392 tíma en skiluðum 
samtals 1309,5 tímum (sjá nákvæmt yfirlit í Dagbók á meðfylgjandi geisladisk).


\subsection{Verklagsreglur}
Kerfi DataMarket er skrifað í Python og því gerðum við slíkt hið sama enda myndi það auðvelda áframhaldandi þróun. 
Kerfið okkar er sjálfstæð eining sem talar við skil (e. API) DataMarket\footnote[1]{http://datamarket.com/api/v1/}. 	
...
Við lögðum hart að okkur við að finna góðar leiðir til greininga á tímalínum og gátum nýtt okkur þekkta aðferð og byggt 
...
Verkefnið mun því gagnast DataMarket til frekari greiningar á tölfræðilegum gögnum.
